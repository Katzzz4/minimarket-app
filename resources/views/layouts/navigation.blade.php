    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-6 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @role('Owner')
                        ...
                        <x-nav-link :href="route('reports.transactions')" :active="request()->routeIs('reports.*')">
                            Laporan
                        </x-nav-link>
                    @endrole
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <div class="text-xs text-gray-400 me-3">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @role('Owner')
                ...
                <x-responsive-nav-link :href="route('users.index')" :active="request()->routeIs('users.*')">Pegawai</x-responsive-nav-link>
                ...
                <x-responsive-nav-link :href="route('reports.transactions')" :active="request()->routeIs('reports.*')">Laporan</x-responsive-nav-link>
            @endrole
            ...
            @role('Supervisor')
                <x-responsive-nav-link :href="route('products.index')" :active="request()->routeIs('products.*')">Katalog</x-responsive-nav-link>
                <x-responsive-nav-link :href="route('transactions.index')" :active="request()->routeIs('transactions.*')">Transaksi</x-responsive-nav-link>
            @endrole
        </div>
